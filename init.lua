...
-- remap Ctrl+Backslash & Ctrl+n to Double escape to go back to normal mode in terminal buffer
...
require('lazy').setup({
  ...
  },
  {
    ...
    opts = {
      pipe_table = {
        -- Trim source padding before calculating widths so tables with uneven
        -- spacing remain compact and readable.
        cell = 'trimmed',
        min_width = 3,
        preset = 'round',
        style = 'full',
...
-- Load my own plugins and scripts
require 'config.mesnip'
